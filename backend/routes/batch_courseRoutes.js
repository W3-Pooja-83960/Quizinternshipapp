...
//get all batch_course
router.get("/all-batch_course", checkRoles(["admin", "coordinator"]), (request, response) => {
...
// Add batch_course
router.post('/add-batch_course',checkRoles(["admin"]),(request,response)=>{
  ...
  // Delete batch_course
  router.delete('/delete-batch_course/:batch_id/:course_id', checkRoles(["admin"]),(request, response) => {
 ...
 // Update batch_course 
  router.put("/update-batch_course",checkRoles(["admin"]), (request, response) => {
